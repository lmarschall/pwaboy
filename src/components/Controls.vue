        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="text-center span-frame">
              <button type="button" id="modalPan" class="btn btn-pan"></button>
            </div>
            <div class="row">
              <div class="col">
  ...
  if (joystickZone != undefined) {
    ...
    joystick.on("dir", (dir: any, data: any) => {
      ...
      switch (data.direction.angle) {
        case "up":
          actualControl = EControl.UP;
          break;
        case "down":
          actualControl = EControl.DOWN;
          break;
        case "right":
          actualControl = EControl.RIGHT;
          break;
        case "left":
          actualControl = EControl.LEFT;
          break;
        default:
          break;
      }
